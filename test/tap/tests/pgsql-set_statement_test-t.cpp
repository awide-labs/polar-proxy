...
int main(int argc, char** argv) {
    ...
    std::vector<TestCase> tests = {
        ...
        {"SET SESSION CHARACTERISTICS AS TRANSACTION ISOLATION LEVEL READ COMMITTED;", true, "SESSION CHARACTERISTICS ISOLATION READ COMMITTED"},
        {"SET SESSION CHARACTERISTICS AS TRANSACTION ISOLATION LEVEL REPEATABLE READ;", true, "SESSION CHARACTERISTICS ISOLATION REPEATABLE READ"},
