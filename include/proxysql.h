...
#define DEB ""
#endif /* DEBUG */
#if defined(POLARDB_PROXY)
#define POLARDB_BUILD_SUFFIX "-polardb"
#if defined(POLARDB_PERF_DEBUG) && POLARDB_PERF_DEBUG
#define POLARDB_PERF_BUILD_SUFFIX "-perf"
#else
#define POLARDB_PERF_BUILD_SUFFIX ""
#endif
#if defined(POLARDB_DEBUG) && POLARDB_DEBUG
#define POLARDB_DEBUG_BUILD_SUFFIX "-debug"
#else
#define POLARDB_DEBUG_BUILD_SUFFIX ""
#endif
#else
#define POLARDB_BUILD_SUFFIX ""
#define POLARDB_PERF_BUILD_SUFFIX ""
#define POLARDB_DEBUG_BUILD_SUFFIX ""
#endif
#define PROXYSQL_VERSION GITVERSION DEB POLARDB_BUILD_SUFFIX \
	POLARDB_PERF_BUILD_SUFFIX POLARDB_DEBUG_BUILD_SUFFIX
